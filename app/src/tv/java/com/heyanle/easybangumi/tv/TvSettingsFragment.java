...
public class TvSettingsFragment extends LeanbackSettingsFragment
    ...
    public static class PrefFragment extends LeanbackPreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public void onCreatePreferences(Bundle bundle, String s) {
            ...
            MutableStateFlow<AnimSources> parsers = (MutableStateFlow<AnimSources>) AnimSourceFactory.INSTANCE.parsers();
            AnimSources value = parsers.getValue();
            List<IHomeParser> iHomeParsers = value.homeParsers();
            List<String> keys =new ArrayList<String>();
            List<String> labels=new ArrayList<String>();
            for (int i = 0; i < iHomeParsers.size(); i++) {
                IHomeParser iHomeParser = iHomeParsers.get(i);
                keys.add(iHomeParser.getKey());
                labels.add(iHomeParser.getLabel());
            }
