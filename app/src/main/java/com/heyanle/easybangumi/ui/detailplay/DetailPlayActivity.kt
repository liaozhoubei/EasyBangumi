    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.bangumiDetail.observe(this){
            ...
            if(it.star){
                ...
                binding.btFollow.setBackgroundColor(getAttrColor(this, com.google.android.material.R.attr.colorSurface))
                binding.btFollow.setTextColor(getAttrColor(this, com.google.android.material.R.attr.colorOnSurface))
            }else{
                binding.btFollow.setText(R.string.follow)

                binding.btFollow.setBackgroundColor(getAttrColor(this, com.google.android.material.R.attr.colorSecondary))
                binding.btFollow.setTextColor(getAttrColor(this, com.google.android.material.R.attr.colorOnSecondary))
            }
